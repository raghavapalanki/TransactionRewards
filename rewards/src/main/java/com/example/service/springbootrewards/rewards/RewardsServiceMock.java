...
public class RewardsServiceMock {
	...
	static {
		...
		transactions.add( new MyTransaction(index++, new Customer(1, "Raghava"), 100.0, "Purchase 1", new Date()) );
		transactions.add( new MyTransaction(index++, new Customer(2, "Reddy"), 50.0, "Purchase 2", new Date()) );
		transactions.add( new MyTransaction(index++, new Customer(3, "Palanki"), 120.0, "Purchase 3", new Date()) );
